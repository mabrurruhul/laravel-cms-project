...
@section('title')
    Khobor - Modern Magazine & Newspaper HTML Template
@endsection
                                    ...
                                    <div class="post post-large post-overlay hero-post">
                                        <div class="post-wrap">
                                            ...
                                            <div class="content">
                                                ...
                                                <!-- Title -->
                                                <h2 class="title"><a href="{{ route('s') }}">Political Allies Are Not
                                                        Friend.</a></h2>

                                                <!-- Meta -->
                                                <div class="meta fix">
                                                    <span class="meta-item date"><i class="fa fa-clock-o"></i>10 March
                                                        2023</span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="post post-overlay hero-post col-lg-12 col-md-6 col-12">
                                        <div class="post-wrap">
                                            ...
                                            <div class="content">
                                                ...
                                                <!-- Title -->
                                                <h4 class="title"><a href="{{ route('s') }}">Hynpodia helps fmale
                                                        travelers find health.</a></h4>
                                    ...
                                    <div class="post post-overlay hero-post col-lg-12 col-md-6 col-12">
                                        <div class="post-wrap">
                                            ...
                                            <div class="content">
                                                ...
                                                <!-- Title -->
                                                <h4 class="title"><a href="{{ route('s') }}">Fashion is about some thing
                                                        that comes from with in you.</a></h4>
                                    ...
                                    <div class="post post-overlay gradient-overlay-1 hero-post col-lg-12 col-md-6 col-12">
                                        <div class="post-wrap">
                                            ...
                                            <div class="content">
                                                ...
                                                <!-- Title -->
                                                <h4 class="title"><a href="{{ route('s') }}">Australia announced squad
                                                        for Bangladesh tour.</a></h4>
                                    ...
                                    <div class="post post-overlay gradient-overlay-1 hero-post col-lg-12 col-md-6 col-12">
                                        <div class="post-wrap">
                                            ...
                                            <div class="content">
                                                ...
                                                <!-- Title -->
                                                <h4 class="title"><a href="{{ route('s') }}">Apple, time to IOS With
                                                        macos.</a></h4>
                        ...
                        <div class="popular-post-slider">
                            ...
                            <div class="post post-small post-list post-dark popular-post">
                                <div class="post-wrap">
                                    ...
                                    <!-- Image -->
                                    <a class="image" href="{{ route('s') }}"><img src="img/post/post-7.jpg"
                                            alt="post"></a>
                                    ...
                                    <div class="content fix">
                                        ...
                                        <!-- Title -->
                                        <h5 class="title"><a href="{{ route('s') }}">Most beautiful lens for an amaing
                                                photo.</a></h5>
                                        ...
                                        <!-- Read More -->
                                        <a href="{{ route('s') }}" class="read-more">continue reading</a>
                            ...
                            <div class="post post-small post-list post-dark popular-post">
                                <div class="post-wrap">
                                    ...
                                    <!-- Image -->
                                    <a class="image" href="{{ route('s') }}"><img src="img/post/post-8.jpg"
                                            alt="post"></a>
                                    ...
                                    <div class="content fix">
                                        ...
                                        <!-- Title -->
                                        <h5 class="title"><a href="{{ route('s') }}">Chicken masala fry with
                                                soses.</a></h5>
                            ...
                            <div class="post post-small post-list post-dark popular-post">
                                <div class="post-wrap">
                                    ...
                                    <!-- Image -->
                                    <a class="image" href="{{ route('s') }}"><img src="img/post/post-9.jpg"
                                            alt="post"></a>
                                    ...
                                    <div class="content fix">
                                        ...
                                        <!-- Title -->
                                        <h5 class="title"><a href="{{ route('s') }}">Sathi is investing villions into
                                                gadgets.</a></h5>
                            ...
                            <div class="post post-small post-list post-dark popular-post">
                                <div class="post-wrap">
                                    ...
                                    <!-- Image -->
                                    <a class="image" href="{{ route('s') }}"><img src="img/post/post-10.jpg"
                                            alt="post"></a>
                                    ...
                                    <div class="content fix">
                                        ...
                                        <!-- Title -->
                                        <h5 class="title"><a href="{{ route('s') }}">Hynpodia helps male travelers
                                                find health.</a></h5>
            ...
            <div class="container">
                            ...
                            <div class="head feature-head">
                                ...
                                <ul class="post-block-tab-list feature-post-tab-list nav d-none d-md-block">
                                    <li class="nav-item"><a class="active" data-bs-toggle="tab"
                                            href="#feature-cat-1">Fashion</a></li>
                                    <li class="nav-item"><a data-bs-toggle="tab" href="#feature-cat-2">Health</a></li>
                                    <li class="nav-item"><a data-bs-toggle="tab" href="#feature-cat-1">Beauty</a></li>
                                    <li class="nav-item"><a data-bs-toggle="tab" href="#feature-cat-2">Sports</a></li>
                                    <li class="nav-item"><a class="dropdown-toggle" data-bs-toggle="dropdown"
                                            href="#">More</a>

                                        <!-- Dropdown -->
                                        <ul class="dropdown-menu">
                                            <li class="nav-item"><a data-bs-toggle="tab"
                                                    href="#feature-cat-1">Technology</a></li>
                                            <li class="nav-item"><a data-bs-toggle="tab" href="#feature-cat-2">Food</a>
                                            </li>
                                        </ul>
                                ...
                                <ul class="post-block-tab-list feature-post-tab-list nav d-sm-block d-md-none">
                                    <li><a class="dropdown-toggle" data-bs-toggle="dropdown" href="#">Category</a>
                                        ...
                                        <ul class="dropdown-menu">
                                            <li class="nav-item"><a class="active" data-bs-toggle="tab"
                                                    href="#feature-cat-1">Fashion</a></li>
                                            <li class="nav-item"><a data-bs-toggle="tab" href="#feature-cat-2">Health</a>
                                            </li>
                                            <li class="nav-item"><a data-bs-toggle="tab" href="#feature-cat-1">Beauty</a>
                                            </li>
                                            <li class="nav-item"><a data-bs-toggle="tab" href="#feature-cat-2">Sports</a>
                                            </li>
                                            <li class="nav-item"><a data-bs-toggle="tab"
                                                    href="#feature-cat-1">Technology</a></li>
                                            <li class="nav-item"><a data-bs-toggle="tab" href="#feature-cat-2">Food</a>
                                            ...
                                            <div class="col-md-6 col-12 mb-20">
                                                ...
                                                <div class="post feature-post post-separator-border">
                                                    <div class="post-wrap">
                                                        ...
                                                        <!-- Image -->
                                                        <a class="image" href="{{ route('s') }}"><img src="5.jpg" alt="new">

                                                        <!-- Content -->
                                                        <div class="content">

                                                            <!-- Title -->
                                                            <h4 class="title"><a href="{{ route('s') }}">with in
                                                                    you.</a></h4>
                                                            ...
                                                            <div class="meta fix">
                                                                ...
                                                                <span class="meta-item date"><i
                                                                        class="fa fa-clock-o"></i>10 March 2023</span>
                                                                <a href="#" class="meta-item comment"><i
                                                                        class="fa fa-comments"></i>(34)</a>
                                                            </div>

                                                            <!-- Description -->
                                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elits.
                                                                Proin nec purus lectus. Aenean sodales quis eros is quis
                                                                eleifend. Vestibulum condimentum.</p>
                                                ...
                                                <div class="post feature-post post-separator-border">
                                                    <div class="post-wrap">
                                                        ...
                                                        <!-- Image -->
                                                        <a class="image" href="{{ route('s') }}"><img
                                                                src="img/post/post-12.jpg" alt="post"></a>

                                                        <!-- Content -->
                                                        <div class="content">

                                                            <!-- Title -->
                                                            <h4 class="title"><a href="{{ route('s') }}">How group of
                                                                    rebel are talking on Banasree epidemic.</a></h4>
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="post-wrap">
                                                            ...
                                                            <div class="content">
                                                                ...
                                                                <!-- Title -->
                                                                <h5 class="title"><a
                                                                        href="{{ route('s') }}">{{ $d->name }}</a>
                                                                </h5>

                                                                <!-- Meta -->
                                                                <div class="meta fix">
                                                                    <span class="meta-item date"><i
                                                                            class="fa fa-clock-o"></i>10 Romadan
                                                                        2024</span>
                                                                </div>
                                            ...
                                            <div class="col-md-6 col-12 mb-20">
                                                ...
                                                <div class="post feature-post post-separator-border">
                                                    <div class="post-wrap">
                                                        ...
                                                        <!-- Image -->
                                                        <a class="image" href="{{ route('s') }}"><img
                                                                src="img/post/post-11.jpg" alt="post"></a>

                                                        <!-- Content -->
                                                        <div class="content">

                                                            <!-- Title -->
                                                            <h4 class="title"><a href="{{ route('s') }}">Fashion is
                                                                    about some thing that comes from with in you.</a></h4>
                                            ...
                                            <div class="col-md-6 col-12 mb-20">
                                                ...
                                                <div class="post post-small post-list feature-post post-separator-border">
                                                    <div class="post-wrap">
                                                        ...
                                                        <!-- Image -->
                                                        <a class="image" href="{{ route('s') }}"><img
                                                                src="img/post/post-16.jpg" alt="post"></a>

                                                        <!-- Content -->
                                                        <div class="content">

                                                            <!-- Title -->
                                                            <h5 class="title"><a href="{{ route('s') }}">Apple, time
                                                                    to IOS With macos.</a></h5>
                                                ...
                                                <div class="post post-small post-list feature-post post-separator-border">
                                                    <div class="post-wrap">
                                                        ...
                                                        <!-- Image -->
                                                        <a class="image" href="{{ route('s') }}"><img
                                                                src="img/post/post-17.jpg" alt="post"></a>
                                                ...
                                                <div class="post post-small post-list feature-post post-separator-border">
                                                    <div class="post-wrap">
                                                        ...
                                                        <!-- Image -->
                                                        <a class="image" href="{{ route('s') }}"><img
                                                                src="img/post/post-18.jpg" alt="post"></a>

                                                        <!-- Content -->
                                                        <div class="content">

                                                            <!-- Title -->
                                                            <h5 class="title"><a href="{{ route('s') }}">Most
                                                                    beautiful lens for an amaing photo.</a></h5>
                                                ...
                                                <div class="post post-small post-list feature-post post-separator-border">
                                                    <div class="post-wrap">
                                                        ...
                                                        <!-- Image -->
                                                        <a class="image" href="{{ route('s') }}"><img
                                                                src="img/post/post-13.jpg" alt="post"></a>

                                                        <!-- Content -->
                                                        <div class="content">

                                                            <!-- Title -->
                                                            <h5 class="title"><a href="{{ route('s') }}">Hynpodia
                                                                    helps female travelers find health.</a></h5>
                                                ...
                                                <div class="post post-small post-list feature-post post-separator-border">
                                                    <div class="post-wrap">
                                                        ...
                                                        <!-- Image -->
                                                        <a class="image" href="{{ route('s') }}"><img
                                                                src="img/post/post-14.jpg" alt="post"></a>

                                                        <!-- Content -->
                                                        <div class="content">

                                                            <!-- Title -->
                                                            <h5 class="title"><a href="{{ route('s') }}">Australia
                                                                    announced squad for Bangladesh tour.</a></h5>
                                                ...
                                                <div class="post post-small post-list feature-post post-separator-border">
                                                    <div class="post-wrap">
                                                        ...
                                                        <!-- Image -->
                                                        <a class="image" href="{{ route('s') }}"><img
                                                                src="img/post/post-15.jpg" alt="post"></a>

                                                        <!-- Content -->
                                                        <div class="content">

                                                            <!-- Title -->
                                                            <h5 class="title"><a href="{{ route('s') }}">Fish Fry
                                                                    With green vegetables.</a></h5>
                    ...
                    <div class="col-lg-4 col-12 mb-50">
                        <div class="row">
                            ...
                            <div class="single-sidebar col-lg-12 col-md-6 col-12">
                                ...
                                <!-- Sidebar Banner -->
                                <a href="#" class="sidebar-banner"><img src="img/banner/sidebar-banner-1.jpg"
                                    ...
                                    <li><a class="dropdown-toggle" data-bs-toggle="dropdown" href="#">Category</a>
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="active" data-bs-toggle="tab"
                                                    href="#life-style-cat-1">Fashion</a></li>
                                            <li><a data-bs-toggle="tab" href="#life-style-cat-2">Health</a></li>
                                            <li><a data-bs-toggle="tab" href="#life-style-cat-1">Beauty</a></li>
                                            <li><a data-bs-toggle="tab" href="#life-style-cat-2">Sports</a></li>
                                            <li><a data-bs-toggle="tab" href="#life-style-cat-1">Technology</a></li>
                                    ...
                                    <div class="tab-pane fade show active" id="life-style-cat-1">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12 mb-20">
                                                ...
                                                <div class="post post-overlay life-style-post post-separator-border">
                                                    <div class="post-wrap">
                                                        ...
                                                        <!-- Image -->
                                                        <div class="image"><img src="img/post/post-19.jpg"
                                                                alt="post"></div>
                                                        ...
                                                        <div class="content">
                                                            ...
                                                            <!-- Title -->
                                                            <h4 class="title"><a href="{{ route('s') }}">Creat Your
                                                                    Home With A Great Designer.</a></h4>
                                                ...
                                                <div class="post post-overlay life-style-post post-separator-border">
                                                    <div class="post-wrap">
                                                        ...
                                                        <!-- Image -->
                                                        <div class="image"><img src="img/post/post-20.jpg"
                                                                alt="post"></div>
                                            ...
                                            <div class="col-md-6 col-12 mb-20">
                                                ...
                                                <!-- Small Post Start -->
                                                <div
                                                    class="post post-small post-list life-style-post post-separator-border">
                                                    <div class="post-wrap">

                                                        <!-- Image -->
                                                        <a class="image" href="{{ route('s') }}"><img
                                                                src="img/post/post-21.jpg" alt="post"></a>
                                                ...
                                                <div
                                                    ...
                                                    <div class="post-wrap">
                                                        ...
                                                        <!-- Image -->
                                                        <a class="image" href="{{ route('s') }}"><img
                                                                src="img/post/post-22.jpg" alt="post"></a>
                                                ...
                                                <div
                                                    ...
                                                    <div class="post-wrap">
                                                        ...
                                                        <!-- Image -->
                                                        <a class="image" href="{{ route('s') }}"><img
                                                                src="img/post/post-23.jpg" alt="post"></a>
                                                ...
                                                <div
                                                    ...
                                                    <div class="post-wrap">
                                                        ...
                                                        <!-- Image -->
                                                        <a class="image" href="{{ route('s') }}"><img
                                                                src="img/post/post-24.jpg" alt="post"></a>
                    ...
                    <div class="col-lg-4 col-12 mb-50">
                        <div class="row">
                                        ...
                                        <div class="sidebar-post-carousel post-block-carousel life-style-post-carousel">
                                            ...
                                            <div class="post life-style-post">
                                                <div class="post-wrap">
                                                    ...
                                                    <!-- Image -->
                                                    <a class="image" href="{{ route('s') }}"><img
                                                            src="img/post/post-25.jpg" alt="post"></a>
                            ...
                            <div class="single-sidebar col-lg-12 col-md-6 col-12">
                                ...
                                <!-- Sidebar Banner -->
                                <a href="#" class="sidebar-banner"><img src="img/banner/sidebar-banner-2.jpg"
                                        alt="Sidebar Banner"></a>
                                ...
                                <div
                                    ...
                                    <div class="post post-small post-list education-post">
                                        <div class="post-wrap">
                                            ...
                                            <!-- Image -->
                                            <a class="image" href="{{ route('s') }}"><img src="img/post/post-27.jpg"
                                                    alt="post"></a>
                                            ...
                                            <div class="content">
                                                ...
                                                <!-- Title -->
                                                <h5 class="title"><a href="{{ route('s') }}">Who Else Wants To Be
                                                        Successful With education.</a></h5>
                                    ...
                                    <div class="post post-small post-list education-post">
                                        <div class="post-wrap">
                                            ...
                                            <!-- Image -->
                                            <a class="image" href="{{ route('s') }}"><img src="img/post/post-28.jpg"
                                                    alt="post"></a>
                                            ...
                                            <div class="content">
                                                ...
                                                <!-- Title -->
                                                <h5 class="title"><a href="{{ route('s') }}">The Biggest Contribution
                                                        Of Education To Humanity.</a></h5>
                                    ...
                                    <div class="post post-small post-list education-post">
                                        <div class="post-wrap">
                                            ...
                                            <!-- Image -->
                                            <a class="image" href="{{ route('s') }}"><img src="img/post/post-29.jpg"
                                                    alt="post"></a>
                                            ...
                                            <div class="content">
                                                ...
                                                <!-- Title -->
                                                <h5 class="title"><a href="{{ route('s') }}">7 Outrageous Ideas For
                                                        Your Graphic Class.</a></h5>
                                    ...
                                    <div class="post post-small post-list education-post">
                                        <div class="post-wrap">
                                            ...
                                            <!-- Image -->
                                            <a class="image" href="{{ route('s') }}"><img src="img/post/post-30.jpg"
                                                    alt="post"></a>
                                            ...
                                            <div class="content">
                                                ...
                                                <!-- Title -->
                                                <h5 class="title"><a href="{{ route('s') }}">Everything You Need To
                                                        Know About Education.</a></h5>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mb-50">
                        ...
                        <div class="post-block-wrapper">
                            ...
                            <div class="body">
                                ...
                                <!-- Sidebar Post Slider Start -->
                                <div
                                    class="two-row-post-carousel row-post-carousel post-block-carousel madical-post-carousel">
                                    ...
                                    <div class="post madical-post">
                                        <div class="post-wrap">
                                            ...
                                            <!-- Image -->
                                            <a class="image" href="{{ route('s') }}"><img src="img/post/post-31.jpg"
                                                    alt="post"></a>
                                            ...
                                            <div class="content">
                                                ...
                                                <!-- Title -->
                                                <h4 class="title"><a href="{{ route('s') }}">If lose your extra
                                                        calorie !! join Friensd Madical.</a></h4>
                                    ...
                                    <div class="post madical-post">
                                        <div class="post-wrap">
                                            ...
                                            <!-- Image -->
                                            <a href="https://www.youtube.com/watch?v=yv04rtsRL3I"
                                                class="image video-popup">
                                                <img src="img/post/post-32.jpg" alt="post">
                                                <!-- Video Button -->
                                        ...
                                        <div class="tab-pane fade show active" id="latest-news">
                                            ...
                                            <div class="post post-small post-list education-post post-separator-border">
                                                <div class="post-wrap">
                                                    ...
                                                    <!-- Image -->
                                                    <a class="image" href="{{ route('s') }}"><img
                                                            src="img/post/post-33.jpg" alt="post"></a>

                                                    <!-- Content -->
                                                    <div class="content">

                                                        <!-- Title -->
                                                        <h5 class="title"><a href="{{ route('s') }}">Hynpodia helps
                                            ...
                                            <div class="post post-small post-list education-post post-separator-border">
                                                <div class="post-wrap">
                                                    ...
                                                    <!-- Image -->
                                                    <a class="image" href="{{ route('s') }}"><img
                                                            src="img/post/post-34.jpg" alt="post"></a>

                                                    <!-- Content -->
                                                    <div class="content">

                                                        <!-- Title -->
                                                        <h5 class="title"><a href="{{ route('s') }}">How do you solve
                                            ...
                                            <div class="post post-small post-list education-post post-separator-border">
                                                <div class="post-wrap">
                                                    ...
                                                    <!-- Image -->
                                                    <a class="image" href="{{ route('s') }}"><img
                                                            src="img/post/post-35.jpg" alt="post"></a>

                                                    <!-- Content -->
                                                    <div class="content">

                                                        <!-- Title -->
                                                        <h5 class="title"><a href="{{ route('s') }}">Home is not a
                                            ...
                                            <div class="post post-small post-list education-post post-separator-border">
                                                <div class="post-wrap">
                                                    ...
                                                    <!-- Image -->
                                                    <a class="image" href="{{ route('s') }}"><img
                                                            src="img/post/post-36.jpg" alt="post"></a>

                                                    <!-- Content -->
                                                    <div class="content">

                                                        <!-- Title -->
                                                        <h5 class="title"><a href="{{ route('s') }}">How do you
                                                                solve the local political page problem.</a></h5>
                                            ...
                                            <div class="post post-small post-list education-post post-separator-border">
                                                <div class="post-wrap">
                                                    ...
                                                    <div class="content">
                                                        ...
                                                        <!-- Title -->
                                                        <h5 class="title"><a href="{{ route('s') }}">How do you
                                                                solve the IOS page problem.</a></h5>
                            ...
                            <div class="head sports-head">
                                ...
                                <ul class="post-block-tab-list sports-post-tab-list nav d-sm-block d-md-none">
                                    <li><a class="dropdown-toggle" data-bs-toggle="dropdown" href="#">Category</a>
                                        ...
                                        <!-- Dropdown -->
                                        <ul class="dropdown-menu">
                                            <li><a class="active" data-bs-toggle="tab" href="#sports-cat-1">Fashion</a>
                                            </li>
                                            <li><a data-bs-toggle="tab" href="#sports-cat-2">Health</a></li>
                                            <li><a data-bs-toggle="tab" href="#sports-cat-1">Beauty</a></li>
                                            <li><a data-bs-toggle="tab" href="#sports-cat-2">Sports</a></li>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="post post-overlay post-large sports-post col-12 mb-20">
                                                        <div class="post-wrap">
                                                            ...
                                                            <!-- Image -->
                                                            <div class="image"><img src="img/post/post-37.jpg"
                                                                    alt="post"></div>
                                                    ...
                                                    <div class="post post-overlay sports-post col-md-6 mb-20">
                                                        <div class="post-wrap">
                                                            ...
                                                            <!-- Image -->
                                                            <div class="image"><img src="img/post/post-38.jpg"
                                                                    alt="post"></div>
                                                    ...
                                                    <div class="post post-overlay sports-post col-md-6 mb-20">
                                                        <div class="post-wrap">
                                                            ...
                                                            <!-- Image -->
                                                            <a href="https://www.youtube.com/watch?v=S50yhCPOyQw"
                                                                class="image video-popup">
                                                    ...
                                                    <div class="col-lg-12 col-md-6 col-12 mb-20">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="post-wrap">
                                                                ...
                                                                <!-- Image -->
                                                                <a class="image" href="{{ route('s') }}"><img
                                                                        src="img/post/post-40.jpg" alt="post"></a>
                                                                ...
                                                                <div class="content">
                                                                    ...
                                                                    <!-- Title -->
                                                                    <h5 class="title"><a
                                                                            href="{{ route('s') }}">Hynpodia helps
                                                                            female travelers find health.</a></h5>

                                                                    <!-- Meta -->
                                                                    <div class="meta fix">
                                                                        <span class="meta-item date"><i
                                                                                class="fa fa-clock-o"></i>10 March
                                                                            2023</span>
                                                                    </div>
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="post-wrap">
                                                                ...
                                                                <!-- Image -->
                                                                <a class="image" href="{{ route('s') }}"><img
                                                                        src="img/post/post-41.jpg" alt="post"></a>
                                                    ...
                                                    <div class="col-lg-12 col-md-6 col-12 mb-20">
                                                        ...
                                                        <div class="post sports-post">
                                                            <div class="post-wrap">
                                                                ...
                                                                <!-- Image -->
                                                                <a class="image" href="{{ route('s') }}"><img
                                                                        src="img/post/post-42.jpg" alt="post"></a>
                                                                ...
                                                                <div class="content">
                                                                    ...
                                                                    <!-- Title -->
                                                                    <h4 class="title"><a
                                                                            href="{{ route('s') }}">Winning T20
                                                                            Farewell To Safari.</a></h4>

                                                                    <!-- Meta -->
                                                                    <div class="meta fix">
                                                                        <a href="#" class="meta-item date"><i
                                                                                class="fa fa-user"></i> Sathi Bhuiyan</a>
                                                                        <span class="meta-item date"><i
                                                                                class="fa fa-clock-o"></i>10 March
                                                                            2023</span>
                                                                    ...
                                                                    <!-- Description s-->
                                                                    <p>Lorem ipsum dolor sit amet, consectet adipiscing
                                                                        elits. Proin nec purus lectus. Aenean sodales quis
                                                                        eros is quis eleifend. </p>
                ...
                <div class="row mb-50">
                    ...
                    <div class="col-12">
                        ...
                        <a href="#" class="post-middle-banner"><img src="img/banner/post-middle-1.jpg"
                                alt="Banner"></a>
                        ...
                        <div class="post post-overlay hero-post mb-30">
                            <div class="post-wrap">
                                ...
                                <a href="https://www.youtube.com/watch?v=S50yhCPOyQw" class="image video-popup">
                                    <img src="img/post/post-46.jpg" alt="post">
                                    <span class="video-btn"><i class="fa fa-play"></i></span>
                                </a>
                        ...
                        <div class="row">
                            ...
                            <div class="single-sidebar col-lg-12 col-md-6 col-12">
                                ...
                                <div class="sidebar-subscribe">
                                    ...
                                    <p>Adipiscing elit. Fusce sed mauris arcu. Praesent ut augue imperdiet, semper lorem id.
                                    </p>
                                    <!-- Newsletter Form -->
                                    <form action="#" method="post" id="mc-embedded-subscribe-form"
                                        name="mc-embedded-subscribe-form" class="subscribe-form validate"
                                ...
                                <div class="sidebar-post-carousel post-block-carousel gadgets-post-carousel">
                                    ...
                                    <div class="post gadgets-post">
                                        <div class="post-wrap">
                                            ...
                                            <!-- Image -->
                                            <a class="image" href="{{ route('s') }}"><img
                                                    src="img/post/post-43.jpg" alt="post"></a>

                                            <!-- Content -->
                                            <div class="content">

                                                <!-- Title -->
                                                <h4 class="title"><a href="{{ route('s') }}">Sony Reveals The
                                                        Xperia Z4, Its Latest Flagship Smartphone.</a></h4>
                                ...
                                <div class="sidebar-post-carousel post-block-carousel fashion-post-carousel">
                                    ...
                                    <div class="post fashion-post">
                                        <div class="post-wrap">
                                            ...
                                            <!-- Image -->
                                            <a class="image" href="{{ route('s') }}"><img
                                                    src="img/post/post-44.jpg" alt="post"></a>

                                            <!-- Content -->
                                            <div class="content">

                                                <!-- Title -->
                                                <h4 class="title"><a href="{{ route('s') }}">The scientific method
                                                        of finding love on the beauty.</a></h4>
                                ...
                                <div class="sidebar-post-carousel post-block-carousel">
                                    ...
                                    <div class="post">
                                        <div class="post-wrap">
                                            ...
                                            <!-- Image -->
                                            <a class="image" href="{{ route('s') }}"><img
                                                    src="img/post/post-45.jpg" alt="post"></a>

                                            <!-- Content -->
                                            <div class="content">

                                                <!-- Title -->
                                                <h4 class="title"><a href="{{ route('s') }}">Tell me how to Achive
                                                        your goal by creating a design.</a></h4>
